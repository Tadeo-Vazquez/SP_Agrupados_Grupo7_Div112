...
# def ejecutar_comodin(comodin:int,matriz_juego:list,stats:dict,comodines:dict): #refactorizado usando dicts con funciones como valores
...
def pedir_posiciones_y_ejecutar_comodin(valores_juego:dict,matriz_desordenada:list):
    ...
    if lista_posiciones[0] > 16:
        valores_juego["comodines"][lista_posiciones[0]-17]["Seleccionado"] = True
        ejecutar_comodin(matriz_desordenada,valores_juego["stats"],valores_juego["comodines"])
...
def listar_categorias_y_comparar(matriz_desordenada,lista_posiciones):
    ...
    return lista_cat_ingresadas,acierto